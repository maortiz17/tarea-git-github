...
public final class Utilidades {
    ...
    //Lo uso para leer id y que me pueda devolver null para controlar si quiere cerrar ticket o no 
    public static Long leerLongOpcional(Scanner sc, String mensaje) {
        while (true) {
            System.out.print(mensaje);
            String entrada = sc.nextLine();
